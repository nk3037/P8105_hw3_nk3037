...
This is a three-panel plot that shows the 24-hour activity time courses for each education level. The color indicates sex.
```{r}
...
```
The plot above shows the distrbition of MIMS values for the three education levels. I could not get the geom_smooth to work. In general, males and females with more than a high school education have higher MIMS scores. Also there is a midday dip in MIMS scores for all three education groups. On average, high school equivalent females had lower spread of MIMS values across the day compared to the other education groups.
